...
public class Application05 {
	public static void main(String[] args) {
		...
		//1. 학생 수 | 2. 학생 정보 입력 | 3. 학생들의 총점, 평균 | 4. 종료
		...
		while(true) {
			...
			if(selectNo.equals("1")) {
				...
				for(int i=0; i<stdAry.length; i++) {
					...
					System.out.println("총 점 :" + stdAry[i].kor + stdAry[i].math + stdAry[i].eng);
					System.out.println("총 점 :" + (stdAry[i].kor + stdAry[i].math + stdAry[i].eng)/3);
				}
